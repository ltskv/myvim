...
hi Directory    ctermfg=27 ctermbg=231 guifg=#0000ff guibg=#ffffff
...
hi NonText      cterm=NONE ctermfg=251 ctermbg=231 gui=NONE guifg=#c0c0c0 guibg=#ffffff
...
hi TabLine      cterm=NONE ctermbg=251 gui=NONE guibg=#c0c0c0
hi TabLineFill  cterm=NONE ctermbg=251 gui=NONE guibg=#c0c0c0
hi TabLineSel   cterm=bold ctermfg=16 ctermbg=231 gui=bold guifg=#000000 guibg=#ffffff
hi StatusLineNormal gui=bold guibg=#c0c0c0 guifg=#000000 cterm=bold ctermbg=251 ctermfg=16
hi StatusLineInsert gui=bold guibg=#80c080 guifg=#000000 cterm=bold ctermbg=108 ctermfg=16
hi! link StatusLine StatusLineNormal
hi StatusLineNc gui=NONE guibg=#c0c0c0 guifg=#808080 cterm=NONE ctermbg=251 ctermfg=244
hi StatusLineTerm cterm=bold ctermfg=231 ctermbg=244 gui=bold guifg=#ffffff guibg=#808080
hi StatusLineTermNc cterm=NONE ctermfg=251 ctermbg=244 gui=NONE guifg=#c0c0c0 guibg=#808080
...
hi String       cterm=NONE ctermfg=124 ctermbg=231 gui=NONE guifg=#c00000 guibg=#ffffff
hi Underlined   cterm=underline ctermfg=27 ctermbg=231 gui=underline guifg=#0000ff guibg=#ffffff

"hi Boolean      cterm=bold
hi Comment      cterm=NONE ctermfg=34 ctermbg=231 gui=NONE guifg=#00c000 guibg=#ffffff
hi Constant     cterm=NONE ctermfg=20 ctermbg=231 gui=NONE guifg=#0000c0 guibg=#ffffff
hi Cursor       cterm=NONE ctermbg=244 gui=NONE guifg=NONE guibg=#c0c0c0
hi CursorColumn ctermbg=3 guibg=#c0c0c0
"hi CursorIM     guibg=fg guifg=bg
hi CursorLine   cterm=bold ctermbg=251 gui=bold guibg=#c0c0c0
hi LineNr       cterm=NONE ctermfg=251 ctermbg=231 gui=NONE guifg=#c0c0c0 guibg=#ffffff
...
hi Statement    cterm=NONE ctermfg=127 ctermbg=231 gui=NONE guifg=#c000c0 guibg=#ffffff
hi Todo         cterm=bold ctermfg=214 ctermbg=231 gui=bold guifg=#ffaf00 guibg=#ffffff
hi Type         cterm=NONE ctermfg=24 ctermbg=231 gui=NONE guifg=#005fa7 guibg=#ffffff
...
hi DiffDelete ctermbg=210 ctermfg=124 guibg=#ffc0c0 guifg=#800000 gui=none cterm=none
